...
msa_wrapper(t, exact_match, protein=True)
msa_wrapper(t, average_match, gap_penalty=-1, protein=True)
msa_wrapper(t, average_match_blosum, gap_penalty=-2, protein=True)
